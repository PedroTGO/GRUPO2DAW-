<?php
 ...
 class Model
 {
      ...
      public function buscarAlimentosPorEnergia($energia)
     {
      ...
      public function buscarAlimentosPorGrasa($grasa)
     {
      ...
      public function buscarAlimentosCombinado($grasa,$energia)
     {
         $grasa = htmlspecialchars($grasa);
         $energia = htmlspecialchars($energia);

         $sql = "select * from alimentos where grasatotal = ". $grasa ."and energia=".$energia. " order by nombre desc";
